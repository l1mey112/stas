...
_s601: db "1048576", 0
_s602: db "PATH", 0
_s603: db 27, "[1m", 27, "[31mlib/os.stas:385:16: ", 27, "[39m", 27, "[22massertation failed, '", 34, "PATH", 34, " enviroment variable not found'", 10, 0
_s604: db 27, "[1m", 27, "[31mlib/salloc.stas:7:40: ", 27, "[39m", 27, "[22massertation failed, 'salloc.guard_size: static buffer length exceeded'", 10, 0
_s605: db 27, "[1m", 27, "[31mlib/salloc.stas:18:26: ", 27, "[39m", 27, "[22massertation failed, 'salloc.rewind: cannot rewind allocation stack to higher length'", 10, 0
_s606: db 27, "[1m", 27, "[31mlib/os.stas:493:12: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: `fork` invocation failed'", 10, 0
_s607: db "/dev/null", 0
_s608: db 27, "[1m", 27, "[31mlib/os.stas:499:57: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: opening `/dev/null` failed'", 10, 0
_s609: db 27, "[1m", 27, "[31mlib/os.stas:503:34: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: failed to clear stdout with `dup2`'", 10, 0
_s610: db 27, "[1m", 27, "[31mlib/os.stas:506:34: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: failed to clear stderr with `dup2`'", 10, 0
...
_s696: db "ECHRNG: Channel number out of range", 10, 0
_s697: db "EL2NSYNC: Level 2 not synchronized", 10, 0
_s698: db "EL3HLT: Level 3 halted", 10, 0
_s699: db "EL3RST: Level 3 reset", 10, 0
_s700: db "ELNRNG: Link number out of range", 10, 0
_s701: db "EUNATCH: Protocol driver not attached", 10, 0
_s702: db "ENOCSI: No CSI structure available", 10, 0
_s703: db "EL2HLT: Level 2 halted", 10, 0
_s704: db "EBADE: Invalid exchange", 10, 0
_s705: db "EBADR: Invalid request descriptor", 10, 0
_s706: db "EXFULL: Exchange full", 10, 0
_s707: db "ENOANO: No anode", 10, 0
_s708: db "EBADRQC: Invalid request code", 10, 0
_s709: db "EBADSLT: Invalid slot", 10, 0
_s710: db "EDEADLOCK: Resource deadlock avoided", 10, 0
_s711: db "EBFONT: Bad font file format", 10, 0
_s712: db "ENOSTR: Device not a stream", 10, 0
_s713: db "ENODATA: No data available", 10, 0
_s714: db "ETIME: Timer expired", 10, 0
_s715: db "ENOSR: Out of streams resources", 10, 0
_s716: db "ENONET: Machine is not on the network", 10, 0
_s717: db "ENOPKG: Package not installed", 10, 0
_s718: db "EADV: Advertise error", 10, 0
_s719: db "ESRMNT: Srmount error", 10, 0
_s720: db "ECOMM: Communication error on send", 10, 0
_s721: db "EDOTDOT: RFS specific error", 10, 0
_s722: db "ENOTUNIQ: Name not unique on network", 10, 0
_s723: db "EBADFD: File descriptor in bad state", 10, 0
_s724: db "EREMCHG: Remote address changed", 10, 0
_s725: db "ELIBACC: Can not access a needed shared library", 10, 0
_s726: db "ELIBBAD: Accessing a corrupted shared library", 10, 0
_s727: db "ELIBSCN: ib section in a.out corrupted", 10, 0
_s728: db "ELIBMAX: Attempting to link in too many shared libraries", 10, 0
_s729: db "ELIBEXEC: Cannot exec a shared library directly", 10, 0
_s730: db "ERESTART: Interrupted system call should be restarted", 10, 0
_s731: db "ESTRPIPE: Streams pipe error", 10, 0
_s732: db "EUCLEAN: Structure needs cleaning", 10, 0
_s733: db "ENOTNAM: Not a XENIX named type file", 10, 0
_s734: db "ENAVAIL: No XENIX semaphores available", 10, 0
_s735: db "EISNAM: Is a named type file", 10, 0
_s736: db "EREMOTEIO: Remote I/O error", 10, 0
_s737: db "ENOMEDIUM: No medium found", 10, 0
_s738: db "EMEDIUMTYPE: Wrong medium type", 10, 0
_s739: db "ENOKEY: Required key not available", 10, 0
_s740: db "EKEYEXPIRED: Key has expired", 10, 0
_s741: db "EKEYREVOKED: Key has been revoked", 10, 0
_s742: db "EKEYREJECTED: Key was rejected by service", 10, 0
_s743: db "ERFKILL: Operation not possible due to RF-kill", 10, 0
_s744: db "EHWPOISON: Memory page has hardware error", 10, 0
_s745: db "ERRNO: Unknown", 10, 0
_s746: db 27, "[1m", 27, "[31mlib/os.stas:516:11: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: `execve` invocation failed'", 10, 0
_s747: db 27, "[1m", 27, "[31mlib/os.stas:524:16: ", 27, "[39m", 27, "[22massertation failed, 'execute_child?: `wait4` invocation failed'", 10, 0
_s748: db "execute_child?: child process was terminated by signal ", 0
_s749: db "Failed to execute process `", 0
_s750: db "`", 0
_s751: db "-O0", 0
_s752: db "-felf64", 0
_s753: db "-Fdwarf", 0
...
_s755: db "chmod", 0
_s756: db "+x", 0
_s757: db "backend took ", 0
_s758: db "created binary `", 0
_s759: db "execve binary `", 0
_s760: db "FATAL: Could not execve file", 10, 0
